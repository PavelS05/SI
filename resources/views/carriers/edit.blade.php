        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl rounded-lg">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                    <h2 class="text-2xl font-bold text-gray-800">Edit Carrier</h2>
                    <p class="mt-1 text-sm text-gray-600">Update the carrier's information in the system.</p>
                </div>

                <!-- Form -->
                <div class="px-6 py-6">
                    <form action="{{ route('carriers.update', $carrier) }}" method="POST" class="space-y-8">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="space-y-1">
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        <input type="text" name="name" id="name" value="{{ $carrier->name }}"
                                            required
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        <input type="text" name="mc" id="mc" value="{{ $carrier->mc }}"
                                            required
                                            class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        <input type="text" name="dbo" id="dbo" value="{{ $carrier->dbo }}"
                                            class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-1">
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        <input type="tel" name="phone" id="phone" value="{{ $carrier->phone }}"
                                            class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                ...
                                <div class="space-y-1 md:col-span-2">
                                    ...
                                    <div class="mt-1 relative rounded-md shadow-sm">
                                        <input type="email" name="email" id="email" value="{{ $carrier->email }}"
                                            class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="mt-1">
                                    <textarea name="notes" id="notes" rows="4"
                                        class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                                        placeholder="Enter any additional notes...">{{ $carrier->notes }}</textarea>
                                </div>
                            </div>
                        </div>
