        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl rounded-lg">
                ...
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Update the user account details below.</p>
                </div>
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <select name="role" id="role" required
                                    ...
                                    <option value="ops" {{ $user->role === 'ops' ? 'selected' : '' }}>Operations</option>
                                    <option value="sales" {{ $user->role === 'sales' ? 'selected' : '' }}>Sales
                                        Representative</option>
                                    <option value="csr" {{ $user->role === 'csr' ? 'selected' : '' }}>Customer Service
                                    </option>
                                </select>
                            </div>
                            @error('role')
